...
root_agent = Agent(
    ...
    name="conduit_agent",
    description="Autonomous pipeline incident response agent powered by Fivetran and Arize.",
    instruction="""
...
5. Based on the failure type, decide the appropriate action:
   ...
   - auth_expiry: report for human review (cannot fix credentials autonomously)
